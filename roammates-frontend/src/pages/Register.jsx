      ...
      <div className="flex items-center justify-center w-full lg:w-1/2 p-8 animate-in fade-in slide-in-from-right-8 duration-700">
        <div className="w-full max-w-[420px] bg-white rounded-[24px] p-8 sm:p-12 shadow-[0_20px_60px_rgba(108,99,255,0.15)] border border-[#E8E8F0]/50">
          <div className="text-center mb-8">
            <h2 className="text-3xl font-[800] text-[var(--text-primary)] mb-2">Create Account ✨</h2>
            <p className="text-[var(--text-secondary)] font-medium">Join Roammates and start planning.</p>
          </div>

          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              <label className="block text-sm font-semibold text-[var(--text-primary)] mb-1.5" htmlFor="fullName">Full Name</label>
              <input 
                id="fullName" 
                type="text" 
            ...
            <div>
              <label className="block text-sm font-semibold text-[var(--text-primary)] mb-1.5" htmlFor="password">Password</label>
              <input 
                id="password" 
                type="password" 
                className="roam-input"
            ...
            <p className="text-center text-sm font-medium text-[var(--text-secondary)] pt-4">
              Already have an account? <Link to="/login" className="text-[#6C63FF] hover:text-[#5A52D5] font-bold">Sign in</Link>
            </p>
          </form>
        </div>
      </div>
